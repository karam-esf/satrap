...
<div style="margin: auto; margin-top: 15px; overflow: auto; width: 1200px; background-color: #f6f6f6">
    ...
    <section id="section">
        ...
        if(isset($result)){
            ...
            {
                $facilities = unserialize($res->facilities);
                echo"<img style='float:right; margin-top: 10px' src='/images/$res->image'>
                        ...
                        <h6 id='stuff-h6-left' >$res->kindBattery &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                        <h6 id='stuff-h6-right' >مدت زمان کارکرد&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                        <h6 id='stuff-h6-left' >$res->timeWork &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                        <h6 id='stuff-h6-right' >گارانتی&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                        ...
                        <h6 id='stuff-h6-right' style='margin-right: 60px' >امکانات&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                        <textarea rows='3' id='stuff-textarea'>$facilities &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</textarea>
