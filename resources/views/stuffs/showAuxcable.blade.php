        ...
        if(isset($result)){
            foreach ($result as $res)
                echo"<img style='float:right; margin-top: 10px' src='/images/$res->image'>
                        <h3 id='showStuff-h3' style='line-height: 60%'><br>$res->mark
                            &nbsp;&nbsp;&nbsp; <br><br>مدل $res->modell&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                         </h3>
                        <h6 id='Technic-h6' >مشخصات فنی&nbsp;&nbsp;&nbsp;</h6><br>
                        <h6 id='stuff-h6-right' >اندازه سیم&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                        <h6 id='stuff-h6-left' >$res->lenght &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                        <h6 id='stuff-h6-right' >گارانتی&nbsp;&nbsp;&nbsp;&nbsp;&nbsp</h6>
                        <h6 id='stuff-h6-left' >$res->warranty &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                        <h6 id='stuff-h6-right' >توضیحات&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                        ...
                        <div style='float: right; height: 250px;'>
                            ...
                            <br>
                            <h6 id='lb-stock' class='stuff-price' style='display: block' >مومجود</h6>
                            <a href='#' class='stuff-shop'>افزودن به سبد خرید
                                <i class='fa fa-shopping-cart fa-2x' style='margin-right: 5px'  ></i>
                            </a>
                        </div>";
        }
        ?>
