        ...
        if(isset($result)){
            foreach ($result as $res)
                echo"<img style='float:right; margin-top: 10px' src='/images/$res->image'>
                        ...
                        <h6 id='stuff-h6-right' >ظرفیت&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                        <h6 id='stuff-h6-left' >$res->capacity &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                        <h6 id='stuff-h6-right' >فرمت&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                        <h6 id='stuff-h6-left' >$res->formatt &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                        <h6 id='stuff-h6-right'  >سرعت&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                        <h6 id='stuff-h6-left' >$res->speed &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
