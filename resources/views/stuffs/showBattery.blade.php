        ...
        if(isset($result)){
            foreach ($result as $res)
                echo"<img style='float:right; margin-top: 10px' src='/images/$res->image'>
                        ...
                        <h6 id='stuff-h6-right' >مدل گوشی&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                        <h6 id='stuff-h6-left' >$res->mobile &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                        <h6 id='stuff-h6-right' >نوع باطری&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                        <h6 id='stuff-h6-left' >$res->kind &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                         <h6 id='stuff-h6-right' >ظرفیت باطری&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                        <h6 id='stuff-h6-left' >$res->capacity&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                        <h6 id='stuff-h6-right' >ولتاژ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                        <h6 id='stuff-h6-left' >$res->voltage &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                        <h6 id='stuff-h6-right' style='margin-right: 10px' >گارانتی&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
