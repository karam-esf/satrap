...
<div style="margin: auto; margin-top: 15px; overflow: auto; width: 1200px; background-color: #f6f6f6">
    ...
    <section id="section">
        ...
        <h3 class="reg-h3">ورود به سایت&nbsp;&nbsp;</h3>
        @if(isset($result))
            <h3 id="result" style="float: right; color: #3c763d" >ثبت نام شما با موفقیت انجام شدلطفا وارد شوید</h3>
        @endif
        <table style="float: right; width: 700px; margin-top: 20px">
            <form style="width:600px; float: right; clear: both;  " action="/signIn"  method="post">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                {!! csrf_field() !!}
                <tr>
                    <td><label id="checkUser" style="width: 300px"></label></td>
                    <td><input type="text" required name="usename" id="username" style=" width: 200px;  "
                               oninput="this.value = this.value.replace(/[^a0-z9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');">
                    </td>
                ...
                <tr style=" ">
                    ...
                    <td style="text-align: right ">
                        <lable style="font-weight: bold">مرا به خاطر بسپار</lable>
                        <input type="checkbox" name="rememberMe" style=" margin-right: 20px">
                    </td>
                    <td style="text-align: left; height: 46px">&nbsp;</td>
                </tr>
                <tr><td colspan="3"><input type="submit" value="ورود به سایت"  class="signIn-submit"></td></tr>
            </form>
        </table>
    </section>
</div>
