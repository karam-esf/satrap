...
<table id="allTable">
    ...
    @foreach($result as $res)
        <tr>
            <form action="select" method="post"  id="memories">
                {!! csrf_field() !!}
                ...
                <td><input type="text" style="width: 100px" name="formatt" readonly value="{{$res->formatt}}"></td>
