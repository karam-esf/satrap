...
<body>
<table id="allTable">
    <th colspan="11" id="all-th">هلدر</th>
    <tr>
    ...
    @foreach($result as $res)
        <tr>
            <form action="select" method="post"  id="holders">
                {!! csrf_field() !!}
                <input type="hidden" name="table" value="holders">
                <input type="hidden" id="group_id" name="group_id" value="13">
