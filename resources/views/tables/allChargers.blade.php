...
<table id="allTable">
    ...
    @foreach($result as $res)
        <tr>
            <form action="select" id="chargers" method="post">
                {!! csrf_field() !!}
                <input type="hidden" id="table" name="table" value="chargers">
                ...
                <td><input style="width: 50px" type="text" name="lenght" readonly value="{{$res->lenght}}"></td>
