...
<body>
<table id="allTable">
    <th colspan="13" id="all-th">اسپیکر</th>
    <tr>
        ...
        <td style="font-weight: bold">نوع باطری</td>
    ...
    @foreach($result as $res)
        <tr>
            <form action="select" method="post"  id="speakers">
                {!! csrf_field() !!}
                <input type="hidden" name="table" value="speakers">
                ...
                <td><input type="text" style="width: 100px" name="kindBattery" readonly value="{{$res->kindBattery}}"></td>
