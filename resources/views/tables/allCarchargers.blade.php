...
<body>
<table id="allTable">
    <th colspan="12" id="all-th">شارژر فندکی</th>
    <tr>
        ...
        <td style="font-weight: bold">اندازه کابل</td>
        <td style="font-weight: bold">تعداد پورت</td>
    ...
    @foreach($result as $res)
        <tr>
            <form action="select" id="carchargers" method="post">
                {!! csrf_field() !!}
                <input type="hidden" id="table" name="table" value="carchargers">
                ...
                <td><input type="text" style="width: 100px" name="color" readonly value="{{$res->color}}"></td>
                <td><input type="text" style="width: 100px" name="modell" readonly value="{{$res->modell}}"></td>
                <td><input type="text" style="width: 100px" name="cable" readonly value="{{$res->cable}}"></td>
                <td><input type="text" style="width: 100px" name="port" readonly value="{{$res->port}}"></td>
