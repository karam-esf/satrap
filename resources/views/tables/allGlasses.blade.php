...
<body>
<table id="allTable">
    <th colspan="11" id="all-th">گلس</th>
    <tr>
    ...
    @foreach($result as $res)
        <tr>
            <form action="select" id="glasses" method="post">
                {!! csrf_field() !!}
                <input type="hidden" id="table" name="table" value="glasses">
                ...
                <td><input type="text" name="color" readonly value="{{$res->color}}"></td>
