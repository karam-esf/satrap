...
<body>
<table id="allTable">
    <th colspan="13" id="all-th">هدفون</th>
    <tr>
    ...
    @foreach($result as $res)
        <tr>
            <form action="select" method="post"  id="headphones">
                {!! csrf_field() !!}
                <input type="hidden" name="table" value="headphones">
                ...
                <td><textarea name="facilities" style="direction: rtl"  readonly >{{($res->facilities)}}</textarea></td>
                <td><input type="text" style="width: 100px" name="timeWork" readonly value="{{$res->timeWork}}"></td>
                <td><input type="text" style="width: 100px" name="kindBattery" readonly value="{{$res->capacity}}"></td>
