    ...
    <script>
        $(document).ready(function () {
            ...
            {//alert(id);
                ...
                $("#formCable").attr('action','/updateCable');
...
<div class="panel panel-default">
    <div class="panel-heading" style="text-align: center; color: #245269; font-size: 18px">ثبت کابل شارژ</div>
    <div class="panel-body" style="text-align: center">
        <form action="/addCable" method="post" id="formCable" >
            {!! csrf_field() !!}
            <input type="hidden" id="ID"  name="id">
            <input type="hidden" id="group_id" name="group_id" value="4">
