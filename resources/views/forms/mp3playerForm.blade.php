    ...
    <script>
        $(document).ready(function () {
            ...
            { //alert(id);
                ...
                $("#formMp3player").attr('action','/updateMp3player');
...
<div class="panel panel-default">
    <div class="panel-heading" style="text-align: center; color: #245269; font-size: 18px">ثبت MP3PLAYER</div>
    <div class="panel-body" style="text-align: center">
        <form action="/addMp3player" method="post" id="formMp3player">
            {!! csrf_field() !!}
