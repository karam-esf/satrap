    ...
    <script>
        $(document).ready(function () {
            ...
            { //alert(id);
                ...
                $("#formHeadphone").attr('action','/updateHeadphone');
                ...
                $("#call").val("<?php  if(isset($result))echo $res->call;?>") ;
...
<div class="panel panel-default">
    <div class="panel-heading" style="text-align: center; color: #245269; font-size: 18px">ثبت هدفون</div>
    <div class="panel-body" style="text-align: center">
        <form action="/addHeadphone" method="post" id="formHeadphone">
            {!! csrf_field() !!}
            ...
            <select name="call" class="formSel" id="call" >
                <option value="دارد">دارد</option>
                <option value="ندارد">ندارد</option>
            </select>
            <label>:قابلیت تماس</label><br>
