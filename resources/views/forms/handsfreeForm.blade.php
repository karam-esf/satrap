    ...
    <script>
        $(document).ready(function () {
            ...
            { //alert(id);
                ...
                $("#formHandsfree").attr('action','/updateHandsfree');
                ...
                $("#timeBattery").val("<?php  if(isset($result))echo $res->timeBattery;?>") ;
                $("#timeStanby").val("<?php  if(isset($result))echo $res->timeStanby;?>") ;
                $("#distance").val("<?php  if(isset($result))echo $res->distance;?>") ;
                $("#material").val("<?php  if(isset($result))echo $res->material;?>") ;
                $("#capacity").val("<?php  if(isset($result))echo $res->capacity;?>") ;
                $("#typeConnection").val("<?php  if(isset($result))echo $res->typeConnection;?>") ;
...
<div class="panel panel-default">
    <div class="panel-heading" style="text-align: center; color: #245269; font-size: 18px">ثبت هندزفری</div>
    <div class="panel-body" style="text-align: center">
        <form action="/addHandsfree" method="post" id="formHandsfree">
            {!! csrf_field() !!}
            ...
            <label>:رنگ</label><br>
            <select name="typeConnection" class="formSel" id="typeConnection">
                <option value="بلوتوث">بلوتوث</option>
                <option value="کابل">کابل</option>
            </select>
            <label>:نوع اتصال</label><br>
            <select name="material" class="formSel" id="material" >
                <option value="-">-</option>
            ...
            <label>:مدت زمان شارژ</label><br>
            <select name="distance" class="formSel" id="distance" >
                <option value="-">-</option>
                <option value="15 متر">15 متر</option>
            </select>
            <label>:فاصله بلوتوث</label><br>
            <select name="timeBattery" class="formSel" id="timeBattery" >
                <option value="1 ساعت">1 ساعت</option>
                <option value="2 ساعت">2 ساعت</option>
            ...
            <select name="timeStanby" class="formSel" id="timeStanby" >
                <option value="1 ساعت">1 ساعت</option>
                <option value="2 ساعت">2 ساعت</option>
                <option value="3 ساعت">3 ساعت</option>
                <option value="4 ساعت">4 ساعت</option>
            ...
            <label>:مدت زمان استند بای</label><br>
