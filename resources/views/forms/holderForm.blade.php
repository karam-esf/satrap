    ...
    <script>
        $(document).ready(function () {
            ...
            { //alert(id);
                ...
                $("#formHolder").attr('action','/updateHolder');
...
<div class="panel panel-default">
    <div class="panel-heading" style="text-align: center; color: #245269; font-size: 18px">ثبت هلدر</div>
    <div class="panel-body" style="text-align: center">
        <form action="/addHolder" method="post" id="formHolder">
            {!! csrf_field() !!}
